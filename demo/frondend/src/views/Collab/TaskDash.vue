<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg shadow-sm border-b border-gray-200 dark:border-gray-700">
      <div class="max-w-7xl mx-auto px-4 py-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Dashboard de Tareas</h1>
            <p class="text-gray-600 dark:text-gray-300">Gestiona y actualiza tus tareas asignadas</p>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      <!-- Filtros con efecto de elevación -->
      ...
      <!-- Lista de tareas con efecto de tarjetas interactivas -->
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden border border-gray-200 dark:border-gray-700">
        ...
        <div v-if="filteredTasks.length === 0" class="text-center py-16">
          ...
          <p class="text-gray-500 dark:text-gray-400 text-lg mb-4">No se encontraron tareas</p>
          <button 
            @click="clearFilters" 
          ...
          <TransitionGroup name="task-list">
            ...
            >
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  ...
                  <div class="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                    <div class="flex items-center space-x-1">
                      ...
                      <span>{{ formatDate(task.endDate) || 'Sin fecha límite' }}</span>
                    </div>
                ...
                <!-- Botón de acción rápida que aparece al hacer hover -->
              ...
              <!-- Sección de estado mejorada con animaciones -->
              <div class="mt-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700 transition-all duration-300 group-hover:shadow-sm">
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-3">
                    <div class="flex items-center space-x-2">
                      ...
                      <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Cambiar a:</span>
                    </div>
                ...
                <!-- Indicador de carga mejorado con animación -->
                <Transition name="slide-fade">
                  <div v-if="updatingTasks.includes(task.id)" class="mt-4 flex items-center justify-center space-x-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
                    ...
                    <div class="flex flex-col">
                      <span class="text-sm font-medium text-blue-700 dark:text-blue-400">Actualizando estado...</span>
    ...
    <!-- Toast de notificación mejorado con animación -->
    <Transition
    ...
    <!-- Toast de error mejorado con animación -->
    <Transition
      enter-active-class="transition-all duration-300 ease-out"
      enter-from-class="transform translate-y-2 opacity-0 scale-95"
      enter-to-class="transform translate-y-0 opacity-100 scale-100"
...
export default {
  ...
  setup() {
    ...
    // Actualizar clase de tema en el documento
    ...
    const changeTaskStatus = async (taskId, newStatus) => {
      ...
      try {
        ...
        showSuccess(`Estado cambiado a ${getStatusDisplay(newStatus)}`)
    ...
    // Abrir detalles de la tarea (simulado)
    const openTaskDetails = (task) => {
      showSuccess(`Abriendo detalles de "${task.name}"`)
      // Aquí podrías implementar un modal o navegación a la vista de detalles
    }
